...
class SAX2DiffTraceSimple {
 ...
 public:
  ...
  // constructor
  SAX2DiffTraceSimple(int nedits, struct varray *ses, std::vector<struct diff_edit> columnoffsets, int difftype);
  ...
  friend struct diff_edit * get_next_diff(SAX2DiffTraceSimple * pstate);
  // output a difference formatted as an Xpath
  friend void output_diff(SAX2DiffTraceSimple * pstate, int numelements);
