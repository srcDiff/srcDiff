...
class SAX2DiffTrace {
 ...
 private:
  ...
  std::vector<int> missed_name_types;  
  std::vector<std::vector<element> > missed_names;  

  std::vector<std::vector<std::vector<int> > > signature_path_pos_old;  
  std::vector<std::vector<std::vector<int> > > signature_path_offsets_old;  
  std::vector<std::vector<std::vector<std::string> > > signature_path_old;  

  std::vector<std::vector<std::vector<int> > >signature_path_pos_new;  
  std::vector<std::vector<std::vector<int> > >signature_path_offsets_new;  
  std::vector<std::vector<std::vector<std::string> > > signature_path_new;  
