...
int main(int argc, char * argv[]) {
...

  {
    ...
    assert(shortest_edit_script_hybrid((void *)test_sequence_one, sequence_one_size, (void *)test_sequence_two, sequence_two_size, &edit_script, compare, accessor, 0, 2) == 4);
