...
#  FindLibApr.cmake
#
#  Copyright (C) 2011-2021  SDML (www.sdml.info)
#
...
find_path(LIBAPR_INCLUDE_DIR NAMES apr.h     HINTS /usr/local/include/apr-1 /usr/include/apr-1
												   ${CMAKE_OSX_SYSROOT}/usr/include/apr-1)
find_library(LIBAPR_APR      NAMES apr-1     HINTS /usr/local/lib /usr/lib /usr/lib64 ${CMAKE_OSX_SYSROOT}/usr/lib)
find_library(LIBAPR_APRUTIL  NAMES aprutil-1 HINTS /usr/local/lib /usr/lib /usr/lib64 ${CMAKE_OSX_SYSROOT}/usr/lib)
