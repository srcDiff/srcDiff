...
const char * const else_nest_types[]                 = { "expr_stmt", "decl_stmt", "return", "comment", "call", "operator", "literal", 0 };
...
const char * const call_possible_nest_types[]        = { "call",  "operator", "literal",                                               0 };
