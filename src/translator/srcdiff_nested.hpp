...
public:
  ...
  static void check_nestable(node_sets * node_sets_old, const std::vector<xNodePtr> & nodes_old, int start_old, int end_old
  ...
  static bool is_nestable(node_set * structure_one, const std::vector<xNodePtr> & nodes_one
                 , node_set * structure_two, const std::vector<xNodePtr> & nodes_two);


  static bool is_same_nestable(node_set *  structure_one, const std::vector<xNodePtr> & nodes_one
                      , node_set * structure_two, const std::vector<xNodePtr> & nodes_two);

  static bool is_better_nested(const std::vector<xNodePtr> & nodes_old, node_sets * node_sets_old, int start_pos_old,
