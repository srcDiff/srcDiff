...
public:
  ...
  static void check_nestable(const node_sets & node_sets_old, const std::vector<std::shared_ptr<srcml_node>> & nodes_old, int start_old, int end_old
  ...
  static bool is_nestable(const node_set & structure_one, const std::vector<std::shared_ptr<srcml_node>> & nodes_one
                 , const node_set & structure_two, const std::vector<std::shared_ptr<srcml_node>> & nodes_two);


  static bool is_same_nestable(const node_set & structure_one, const std::vector<std::shared_ptr<srcml_node>> & nodes_one
                      , const node_set & structure_two, const std::vector<std::shared_ptr<srcml_node>> & nodes_two);

  static bool is_better_nested(const std::vector<std::shared_ptr<srcml_node>> & nodes_old, const node_sets & node_sets_old, int start_pos_old,
