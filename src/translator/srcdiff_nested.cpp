...
int is_block_type(const node_set & structure, const std::vector<srcml_node *> & nodes) {
...
bool has_internal_structure(const node_set & structure, const std::vector<srcml_node *> & nodes, const boost::optional<std::string> & type) {
...
bool is_nest_type(const node_set & structure, const std::vector<srcml_node *> & nodes
                           , const node_set & structure_other, const std::vector<srcml_node *> & nodes_other, int type_index) {
...
bool is_match(const srcml_node * node, const void * context) {

  return (xmlReaderTypes)node->type == XML_READER_TYPE_ELEMENT && srcdiff_compare::node_compare(node, (srcml_node *)context) == 0;

}

int best_match(const std::vector<srcml_node *> & nodes, const node_sets & set, const std::vector<srcml_node *> & nodes_match, const node_set & match, int operation) {
...
bool is_nestable_internal(const node_set & structure_one, const std::vector<srcml_node *> & nodes_one
...
bool srcdiff_nested::is_same_nestable(const node_set & structure_one, const std::vector<srcml_node *> & nodes_one
                      , const node_set & structure_two, const std::vector<srcml_node *> & nodes_two) {
...
bool srcdiff_nested::is_nestable(const node_set & structure_one, const std::vector<srcml_node *> & nodes_one
                 , const node_set & structure_two, const std::vector<srcml_node *> & nodes_two) {
...
bool is_better_nest_no_recursion(const std::vector<srcml_node *> & nodes_outer, const node_set & node_set_outer,
                    const std::vector<srcml_node *> & nodes_inner, const node_set & node_set_inner,
...
bool is_better_nest(const std::vector<srcml_node *> & nodes_outer, const node_set & node_set_outer,
                    const std::vector<srcml_node *> & nodes_inner, const node_set & node_set_inner,
                    int similarity, int difference, int text_outer_length, int text_inner_length) {
...
bool srcdiff_nested::is_better_nested(const std::vector<srcml_node *> & nodes_old, const node_sets & node_sets_old, int start_pos_old,
...
void srcdiff_nested::check_nestable(const node_sets & node_sets_old, const std::vector<srcml_node *> & nodes_old, int start_old, int end_old
