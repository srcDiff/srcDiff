#ifndef INCLUDED_SRCDIFFCOMMENT_HPP
#define INCLUDED_SRCDIFFCOMMENT_HPP
...
void output_comment_paragraph(reader_state & rbuf_old, std::vector<std::vector<int> *> * node_sets_old, reader_state & rbuf_new, std::vector<std::ve
ctor<int> *> * node_sets_new, writer_state & wstate);
