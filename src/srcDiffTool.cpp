...
void srcDiffTool::translate(const char* path_one, const char* path_two, const char* unit_directory,
  ...
  // translate file one
  translate_to_srcML(language, src_encoding,  "UTF-8", output_srcml_file, options, unit_directory, path_one, unit_version, 0, 8);
  ...
  */
  ...
  xmlTextReaderPtr reader_new = NULL;
    ...
    // translate file two
  translate_to_srcML(language, src_encoding,  "UTF-8", output_srcml_file, options, unit_directory, path_two, unit_version, 0, 8);
