...
void output_start_document(std::ostream & colordiff_file, std::string & css_url) {
  ...
  colordiff_file << "<span class=\"" << insert_color << " " << diff_color_insert << "\">Line && srcDiff Insert</span>"; 
  colordiff_file << "<span class=\"" << diff_color_insert << "\">Line Insert</span>"; 
  colordiff_file << "<span class=\"" << insert_color << "\">srcDiff Insert</span>"; 
  colordiff_file << "<span class=\"" << delete_color << "\">srcDiff Delete</span>"; 
  colordiff_file << "<span class=\"" << diff_color_delete << "\">Line Delete</span>"; 
  colordiff_file << "<span class=\"" << delete_color << " " << diff_color_delete << "\">Line && srcDiff Delete</span>"; 
