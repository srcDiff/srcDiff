...
public:
    ...
    named_construct(const construct* parent, std::size_t& start, std::shared_ptr<nest_rule_checker> nest_checker)
        : construct(parent, start, std::make_shared<nest_rule_checker>(*this)), name_child() {} 
