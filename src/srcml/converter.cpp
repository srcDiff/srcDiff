...
std::shared_ptr<srcML::node> converter::get_current_node(xmlTextReaderPtr reader) {
...
converter::converter(bool split_strings) 
...
void converter::convert(srcml_unit* unit) {
